<div class="container mt-3 col-xl-10 col-xxl-8 px-4 py-5">
    ...
    <?php }?>
    <div class="row bg-light align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center">
            <h1 class="display-4 fw-bold lh-1 mb-3">Register</h1>
        </div>
        <div class="col-md-10 mx-auto col-lg-5">
            <form class="p-4 p-md-5 border border-success rounded-3 bg-light" method="post" action="/users/register">
